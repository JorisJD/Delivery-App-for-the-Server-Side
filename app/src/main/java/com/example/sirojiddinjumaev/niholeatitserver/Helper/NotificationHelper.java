package com.example.sirojiddinjumaev.niholeatitserver.Helper;
...
public class NotificationHelper extends ContextWrapper {
    ...
    private static final String NIHOL_CHANEL_ID = "com.example.sirojiddinjumaev.niholeatitserver.NiholEatIt";
