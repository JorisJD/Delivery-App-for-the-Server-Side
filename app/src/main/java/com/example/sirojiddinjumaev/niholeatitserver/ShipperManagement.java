...
import com.example.sirojiddinjumaev.niholeatitserver.Model.Shipper;
import com.example.sirojiddinjumaev.niholeatitserver.ViewHolder.ShipperViewHolder;
        ...
        shippers.child(key)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(ShipperManagement.this, "Removed succeed", Toast.LENGTH_SHORT).show();
                    }
