...
import com.example.sirojiddinjumaev.niholeatitserver.Model.Category;
...
import com.example.sirojiddinjumaev.niholeatitserver.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    private void updateToken(String token) {
        ...
        Token data = new Token(token, true); //false because this token send from client side
    ...
    private void showDialog() {
        ...
        btnSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                chooseImage();    //Let user select image from Gallery and upload Uri of this image
            }
        });
    ...
    private void deleteCategory(String key) {
        ...
        Toast.makeText(this, "Item Delated !!! ", Toast.LENGTH_SHORT).show();
    }
